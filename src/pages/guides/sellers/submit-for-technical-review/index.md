...
When your [extension entry](../extension-information/) is complete, you can submit your extension for technical review. During the process, we review the code according to [technical guidelines](../technical-review-guidelines/), install and use the extension according to your documentation, and verify specifics from your submission form. You can track the status and progress of your extension submission through your Marketplace account.

![](../../sellers/_images/tech-review-content.png)

The following instructions show how to submit an extension for Technical Review. The process is essentially the same for [themes](../themes/) and [shared packages](../shared-packages/).

<InlineAlert variant="info" slots="text"/>

**Important - Shared Packages**: If your extension uses [Shared Packages](../shared-packages/) (or components), the packages must be ready and associated with your submission. You will not be able to submit your extension to Technical Review until the shared packages are available in your account.
...
-  Review the [technical](../technical-review-guidelines/) guidelines to ensure that your extension meets Commerce Marketplace and Magento development requirements.
...
1. If you have not submitted the [Marketing Review](../submit-for-marketing-review/), complete those steps to submission.
...
|[Shared Packages](../shared-packages/)|If applicable, identifies each shared package that is required by this extension.|
