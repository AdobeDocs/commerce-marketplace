...
1. If other components are used by an Commerce extension, select the relevant **Shared Package**.
...
|Field|Description|
|--- |--- |
|Magento Version Compatibility|Specifies each version of Commerce the listing supports.|
