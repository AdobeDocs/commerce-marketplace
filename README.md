...
This repository is used to store the code for the [Commerce Marketplace documentation](https://developer.adobe.com/commerce/marketplace/) website. It is built using the [Adobe Edge Delivery Services](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/edge-delivery/overview) and deployed to [Adobe Developer](https://developer.adobe.com/commerce/marketplace/).

This site contains the latest Adobe Commerce and Magento Open Source developer documentation for the Commerce Marketplace.
